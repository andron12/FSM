		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP FSM UI5 extension",
									"targetURL": "#epamui5extension-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"epamui5extension-display": {
								"semanticObject": "epamui5extension",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=epam.ui5extension",
									"url": sap.ui.require.toUrl("epam/ui5extension")
								}
							}
						}
					}
